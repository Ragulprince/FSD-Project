        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">Simplifying e-commerce management for businesses of all sizes.</p>
            </div>
            <div>
              <h3 className="text-xl font-semibold mb-4">Features</h3>
              <ul className="text-gray-400 space-y-2">
                <li><a href="#" className="hover:text-white">Order Listing</a></li>
                <li><a href="#" className="hover:text-white">Order Details</a></li>
